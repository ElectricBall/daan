...
<?php include(ROOT_PATH . '/controller/program.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
      ...
      <div class="row text-center g-4 my-4" id="programs">
        ...
        <div class="container lead">
          <form action="edit_program.php" method="post" enctype="multipart/form-data">
            <input type="hidden" class="form-control" id="prog_id" name="program_id" value="<?php echo $id; ?>" readonly>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="file" class="form-control" id="prog_image" name="image" value="<?php echo $image; ?>">
            </div>
            <div class="mb-3">
              <label for="prog_name" class="form-label">Name</label>
              <input type="text" class="form-control" id="prog_name" name="name" value="<?php echo $name; ?>">
            </div>
            <div class="mb-3">
              <label for="prog_con" class="form-label">Content</label>
              <textarea rows="20" cols="50" class="form-control" id="prog_con" name="content"><?php echo $content; ?></textarea>
            </div>
